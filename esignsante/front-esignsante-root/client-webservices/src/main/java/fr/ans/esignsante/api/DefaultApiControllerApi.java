...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-07-04T13:37:15.229Z[GMT]")@Component("fr.ans.esignsante.api.DefaultApiControllerApi")
public class DefaultApiControllerApi {
    private ApiClient apiClient;

    public DefaultApiControllerApi() {
        this(new ApiClient());
    }

    @Autowired
    public DefaultApiControllerApi(ApiClient apiClient) {
