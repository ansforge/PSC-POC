...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-07-04T13:37:15.229Z[GMT]")@Component("fr.ans.esignsante.api.CaApiControllerApi")
public class CaApiControllerApi {
    private ApiClient apiClient;

    public CaApiControllerApi() {
        this(new ApiClient());
    }

    @Autowired
    public CaApiControllerApi(ApiClient apiClient) {
