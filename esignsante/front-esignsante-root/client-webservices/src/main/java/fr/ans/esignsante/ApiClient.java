...
import fr.ans.esignsante.auth.ApiKeyAuth;
import fr.ans.esignsante.auth.Authentication;
import fr.ans.esignsante.auth.HttpBasicAuth;
import fr.ans.esignsante.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-07-04T13:37:15.229Z[GMT]")@Component("fr.ans.esignsante.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://esignsante.asipsante.fr/{basePath}";
