...
//				new ClassPathResource("EsignSanteWS/Xades/signedipsfra.xml").getFile().toPath()));
    	...
    	MockMultipartFile fileXML = new MockMultipartFile(
    	 ...
    	 httpHeaders.add(AbstractApiDelegate.HEADER_NAME_TOKEN_PSC, "Bearer PSC");
    	 httpHeaders.add(AbstractApiDelegate.HEADER_NAME_TOKEN_API, "Bearer jeton d'api");
	...
	public void checkNotEmptyInputParametersTest () throws IOException {
		...
		//cas non passant
		checkNotEmptyInputParametersKO (null,null,null,null, null);
		checkNotEmptyInputParametersKO ("token","jwt",null,"userinfo", "tokenValidationResponse");
		checkNotEmptyInputParametersKO ("token","jwt",emptyFile,"userinfo", "tokenValidationResponse");
		checkNotEmptyInputParametersKO (null,"jwt",emptyFile,null, "tokenValidationResponse");
		checkNotEmptyInputParametersKO (null,"jwt",emptyFile,"userinfo", "tokenValidationResponse");
		checkNotEmptyInputParametersKO ("token","jwt",file,null, "tokenValidationResponse");
		checkNotEmptyInputParametersKO (null,"jwt",file,null, "tokenValidationResponse");
		checkNotEmptyInputParametersKO ("","jwt",file,"userinfo", "tokenValidationResponse");
		checkNotEmptyInputParametersKO ("token","jwt",file,"", "tokenValidationResponse");
		checkNotEmptyInputParametersKO ("token","jwt",file,null, "tokenValidationResponse");
		checkNotEmptyInputParametersKO (null,"jwt",file,"userinfo", "tokenValidationResponse");
		checkNotEmptyInputParametersKO (null,"jwt",file,"userinfo", null);
		checkNotEmptyInputParametersKO ("token","jwt",file,"userinfo", null);
		//cas  passant
	...
	private void checkNotEmptyInputParametersKO(String accessToken, String tokenAPI,MultipartFile file, String userinfo, String tokenValidationResponse ) {
		var askKO = new AsksignatureApiDelegateImpl();
		try {
			askKO.checkNotEmptyInputParameters(accessToken,tokenAPI, file, userinfo, tokenValidationResponse); 
		assertTrue(false);
		}
		catch (Exception e) {
