 ...
 */
public class RevocationCertificatTest {

    /** The Constant LOG. */
    private static final Logger LOG = LoggerFactory.getLogger(RevocationCertificatTest.class);
    ...
    public void init() throws Exception {
        ...
        rulesNames.add("RevocationCertificat");
    ...
    /**
     * Test avec un certificat PEM révoqué.
     *
     * @throws Exception the exception
     */
//    @Test Désactivé car le certificat révoqué est également expiré
    public void certificatRevoqueTest() throws Exception {
        rapport = validator.validateCertificat(getDocument("tomwsrevoque.henix.asipsante.fr.pem"), params,
                getCACRLWrapper());
        assertFalse("Le rapport indique à tort que le certificat n'est pas révoqué", rapport.isValide());
